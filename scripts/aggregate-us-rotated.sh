...
#$cmd $inputDir/05-16-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-17-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-18-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-19-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-20-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-21-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-22-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-23-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-24-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-25-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-26-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-27-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-28-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-29-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-30-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/05-31-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-01-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-02-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-03-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-04-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-05-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-06-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-07-2020.csv State Rotate $filter | tail -n+2 >> $output
#$cmd $inputDir/06-08-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-09-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-10-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-11-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-12-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-13-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-14-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-15-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-16-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-17-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-18-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-19-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-20-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-21-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-22-2020.csv State Rotate $filter | tail -n+2 >> $output
$cmd $inputDir/06-23-2020.csv State Rotate $filter | tail -n+2 >> $output